...
const ModalDeleteLecture = ({ open, onClose, data, dataType}) => {
  if (!open) return null;
    ...
    <div onClick={onClose} className={cx("overlay")}>
      ...
      >
        <div className={cx("modalContent")}>
          <div>
            <p className={cx("modalsubHeader")}>Do you want to delete this "{data.Title}" ???</p>
...
export default ModalDeleteLecture;
