...
const TestResult = ({ numCorrectAnswers, totalQuestions, className }) => {
  const percentage = ((numCorrectAnswers / totalQuestions) * 100).toFixed(2);
  return (
        ...
        <div className={cx("result-content")}>
          ...
          <div>
            ...
            <p className={cx("result-detail")}>
              ...
              <span className={cx("result-details")}> {numCorrectAnswers}/{totalQuestions}</span>
            </p>

            <p className={cx("result-detail")}>
              Number of wrong answers:
              <span className={cx("result-details")}> {totalQuestions - numCorrectAnswers}/{totalQuestions}</span>
            </p>
          </div>
        </div>
      </div>
