...
import styles from "../CoursesIns.module.scss";
  ...
  return (
    <div className={cx("course-item")}>
      <div className={cx("course-item-content")}>
        <Link to={`${routes.createLesson}/${data.CourseId}`}>
          <img src={data.ImageSrc} className={cx("course-item-image")} alt="Course" />
        </Link>
        <div className={cx("info")}>
          <Link to={`${routes.createLesson}/${data.CourseId}`}className={cx("name")}>
            {data.CourseName}
          </Link>
          <div className={cx("action")}>
            <Link to={`${routes.updateCourse}/${data.CourseId}`} className={cx("action-link")}>
